...
public class _05_charAt {
    public static void main(String[] args) {
        /*
        Method Task: It gets a character at a specific index
        NOTE: Index starts with zero
        -It is non-static as we call it with object name
        -It is a return type and returns a char primitive
        -It takes an argument which is an int (index)
        ...
        print "This name does not start with A" otherwise
         */
