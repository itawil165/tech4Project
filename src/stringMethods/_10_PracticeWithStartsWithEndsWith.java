...
public class _10_PracticeWithStartsWithEndsWith {
    public static void main(String[] args) {
        ...
        // making uppercase to only check startsWith 'A'
        if(name.toUpperCase().startsWith("A")){
            System.out.println("You are in the club A");
        }
        else System.out.println("You are not in the club A");

        // making lowercase to only check startsWith 'a'
        if(name.toLowerCase().startsWith("a")){
            System.out.println("You are in the club A");
        }
        else System.out.println("You are not in the club A");

        // checking the first char to be 'A' or 'a'
        if(name.charAt(0) == 'A' || name.charAt(0) == 'a'){
            System.out.println("You are in the club A");
        }
        else System.out.println("You are not in the club A");

        // making uppercase to only check first char 'A'
        if(name.toUpperCase().charAt(0) == 'A'){
            System.out.println("You are in the club A");
        }
        else System.out.println("You are not in the club A");

        // making lowercase to only check first char 'a'
        if(name.toLowerCase().charAt(0) == 'a'){
            System.out.println("You are in the club A");
        }
        else System.out.println("You are not in the club A");

        // using ASCII values of 'A' and 'a'
