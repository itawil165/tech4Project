...
public class ArrayAndListRecap {
    public static void main(String[] args) {

        /*
        Create an int array and store 1, 5, 7, 9, 10
        Then, print the array
        */
        System.out.println("\n-------int array-------\n");
        int[] nums = {1, 5, 7, 9, 10, 10}; // null is not allowed as it is a primitive array
        System.out.println(Arrays.toString(nums));
        System.out.println(nums[2]); // 7


        /*
        Create a String array to store the cities
        Tokyo, Berlin, Oslo, Denver, null, null
        Then, print the array
        */
        System.out.println("\n-------String array-------\n");
